...
class SER_FIQ:
    def __init__(self,
        ...
        """
        self.device = mx.cpu() if gpu is None else mx.gpu(gpu)
        ...
        if not os.path.exists(model_path):
            ...
            print(f"Downloading SER_FIQ model from Google Drive to {download_file}, file id: {file_id}...")
            download_file_from_google_drive(file_id, download_file)
